...
// 1) Para qué sirve: manejar clics de navegación y expansión en cada ítem del menú.
// 2) Cómo funciona: valida disabled, ejecuta command y actualiza estado de rutas/overlay.
// 3) Qué hace: controla apertura de submenús y cierre de panel móvil.
// 4) Cómo editarla: ajusta ramas de navegación si cambias la estructura del menú.
...
// 1) Para qué sirve: activar submenú por hover en escritorio.
// 2) Cómo funciona: si hay hover activo y el ítem es raíz con hijos, fija activePath.
// 3) Qué hace: mejora navegación rápida en modo desktop.
// 4) Cómo editarla: modifica condición si deseas hover también en modo móvil/tablet.
const onMouseEnter = () => {
